...
try:
    ...
    ntptime.host = "pool.ntp.org"   # Optional: set specific NTP server
    ntptime.settime()               # This sets the RTC (real-time clock) to UTC
    print("Time synced!")
except Exception as e:
    print("Failed to sync time:", e)

# Show current local time (UTC by default)
#while True:
# machine.RTC().datetime() returns a tuple (year, month, day, weekday, hour, minute, second, subseconds)
t = time.localtime(time.time()+TIMEZONE_OFFSET)  # gets tuple in UTC
print(t)
print("UTC Time:", "{:02d}:{:02d}:{:02d}".format(t[3], t[4], t[5]))
print("UTC Date:", "{:04d}-{:02d}-{:02d}".format(t[0], t[1], t[2]))
#time.sleep(60.1)



# Ejemplo de uso: configurar el RTC para 1 de enero de 2023, 12:00:00 PM, domingo
configurar_rtc(t[0], t[1], t[2],t[6],t[3], t[4], t[5])#(2023, 1, 1, 0, 12, 0, 0)
